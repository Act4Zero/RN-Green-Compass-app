...
export default function KnowledgeHubScreen() {
  ...
  const { user } = useAuth();
  const { locale, setLocale, t } = useKnowledgeLocale();
  ...
  const load = useCallback(async () => {
    ...
    try {
      ...
      setError(t('The Knowledge Hub could not load.', 'Центърът за знания не можа да бъде зареден.'));
    }
  }, [user, locale, t]);
