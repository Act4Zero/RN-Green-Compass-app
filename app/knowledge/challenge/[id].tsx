...
export default function KnowledgeChallengeScreen() {
  ...
  return <Screen><ScrollView showsVerticalScrollIndicator={false}><Content>
    ...
    <Text style={[theme.typography.bodySmall, { color: theme.colors.textMuted, textAlign: 'center', marginTop: 20 }]}>{t(`${challenge.rewardPoints} Green Points are awarded once after server validation.`, `${challenge.rewardPoints} зелени точки се дават еднократно след сървърна проверка.`)}</Text>
