...
const REPORT_REASON_LABELS: Record<string, { en: string; bg: string }> = {
  spam: { en: 'Spam', bg: 'Спам' },
  harassment: { en: 'Harassment', bg: 'Тормоз' },
  misinformation: { en: 'Misinformation', bg: 'Подвеждаща информация' },
  unsafe: { en: 'Unsafe content', bg: 'Опасно съдържание' },
